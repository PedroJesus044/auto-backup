        ...
        chartArray: [
          {
            ...
            datasets: [ { data: [66560, 51200, 66560, 204800, 102400, 150298] } ]
            },
            chartOptions: {
              responsive: true
            }
          },
          {
            chartData: {
            labels: [ '17/06/2024', '18/06/2024', '19/06/2024', '20/06/2024', '21/06/2024', '22/06/2024' ],
            datasets: [ { data: [150298, 102400, 66560, 204800, 102400, 150298] } ]
            },
            chartOptions: {
              responsive: true
            }
          },
          {
            chartData: {
            labels: [ '17/06/2024', '18/06/2024', '19/06/2024', '20/06/2024', '21/06/2024', '22/06/2024' ],
            datasets: [ { data: [51200, 204800, 66560, 66560, 102400, 150298] } ]
            },
            chartOptions: {
              responsive: true
            }
